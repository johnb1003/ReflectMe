    ...
    if((currMonthData != undefined) && ((""+dateNum) in currMonthData)) {
        ...
        cardioEvents.forEach(element => {
            ...
            if(durationExists) {
                ...
                viewIDs.cardio[element.cardioid] = '1.2fr 1.2fr 1fr 1fr 1.2fr';
                //$('#full-week-cardio-'+element.cardioid).css('grid-template-columns', '1fr 1fr 1fr 1fr 1fr');
            }
            else {
                viewIDs.cardio[element.cardioid] = '1.2fr 1.2fr 2.2fr 1.2fr';
        ...
        strengthEvents.forEach(element => {
            ...
            dayViewHTML += '</div></div>';
            viewIDs.strength[element.strengthid] = '1.2fr 1.2fr 2.2fr 1.2fr';
